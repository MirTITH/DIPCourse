...
void NormalMode(const Mat leftMask, const Mat rightMask, Mat leftBGR, Mat rightBGR)
{
...
void EndLineDetect(const Mat &BinaryImg)
{
    Mat temp;
    ...
    double distance = CalcLinesAvgDistance(BinaryImg, lines);
...
void dip_main()
{
    ...
    while (true)
    {
        ...
        NormalMode(leftMask, rightMask, leftFrame, rightFrame);
        EndLineDetect(leftMask);
